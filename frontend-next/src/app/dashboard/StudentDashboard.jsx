    ...
    <div className="review-layout">
      <header className="review-topbar">
        ...
        <div className="topbar-right" style={{ display: 'flex', gap: '1rem', alignItems: 'center' }}>
          ...
          <button className="theme-toggle" onClick={() => { router.push('/exam') }}>Take Exam</button>
          <button className="theme-toggle" onClick={() => { localStorage.clear(); router.replace('/login') }}>Sign Out</button>
        </div>
      </header>
